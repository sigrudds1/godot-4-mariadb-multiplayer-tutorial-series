...
--
-- Table structure for table `awaiting_match`
--

DROP TABLE IF EXISTS `awaiting_match`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `awaiting_match` (
...
CREATE TABLE `builds` (
  ...
  CONSTRAINT `builds_item_FK` FOREIGN KEY (`item_id`) REFERENCES `items` (`id`),
...
CREATE TABLE `inventory` (
  ...
  `item_id` bigint(20) unsigned NOT NULL,
  `qty` decimal(14,5) DEFAULT 0.00000,
...
CREATE TABLE `item_stats` (
  ...
  CONSTRAINT `item_stats_item_FK` FOREIGN KEY (`item_id`) REFERENCES `items` (`id`),
...
-- Dump completed on 2025-08-04 13:42:47
