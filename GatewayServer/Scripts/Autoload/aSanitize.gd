...
var _email := RegEx.new()
var _hex := RegEx.new()
var _ipv4 := RegEx.new()
var _ipv6 := RegEx.new()
var _password_hash := RegEx.new()
var _password_plain := RegEx.new()

var _url := RegEx.new()
var _username := RegEx.new()
var _versioning := RegEx.new()
...
func _ready() -> void :
	...
	err = _display_name.compile("^[a-zA-Z]{3}[a-zA-Z0-9_.#&$-]{0,61}$")
